...
from sqlalchemy import String, Integer, BigInteger, JSON, ForeignKey, Index
...
class Asset(Base, TimestampMixin, TenantMixin, AuditMixin, SoftDeleteMixin):
    ...
    status: Mapped[AssetStatus] = mapped_column(String, default=AssetStatus.UPLOADING, nullable=False)

    workspace: Mapped["Workspace"] = relationship("Workspace", lazy="selectin", back_populates="assets")
