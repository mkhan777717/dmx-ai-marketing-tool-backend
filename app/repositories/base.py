...
class BaseRepository(Generic[ModelType]):
    ...
    async def get_by_id(self, db: AsyncSession, id: uuid.UUID, include_deleted: bool = False) -> ModelType | None:
    ...
    async def count(self, db: AsyncSession, filters: dict[str, Any] = None, include_deleted: bool = False) -> int:
    ...
    async def delete(self, db: AsyncSession, *, id: uuid.UUID, soft: bool = True) -> bool:
    ...
    async def exists(self, db: AsyncSession, id: uuid.UUID, include_deleted: bool = False) -> bool:
    ...
    async def bulk_insert(self, db: AsyncSession, objects: list[dict[str, Any]]) -> None:
        if not objects:
            return
    ...
    async def bulk_update(self, db: AsyncSession, objects: list[dict[str, Any]]) -> None:
        """
