...
def downgrade() -> None:
    ...
    op.add_column('users', sa.Column('two_factor_enabled', sa.BOOLEAN(), autoincrement=False, nullable=False))
    op.add_column('users', sa.Column('password_changed_at', sa.DateTime(), autoincrement=False, nullable=True))
    op.add_column('users', sa.Column('last_login', sa.DateTime(), autoincrement=False, nullable=True))
