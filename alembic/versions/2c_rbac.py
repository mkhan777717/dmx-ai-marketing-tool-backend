...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "resource", "action", name=op.f("uq_permissions_resource_action")
        ),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("description", sa.String(), nullable=True),
        sa.Column(
            "role_type", sa.Enum("SYSTEM", "CUSTOM", name="roletype"), nullable=False
        ),
        sa.Column("is_system", sa.Boolean(), nullable=False),
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_index(
        op.f("ix_roles_workspace_id"), "roles", ["workspace_id"], unique=False
    )
